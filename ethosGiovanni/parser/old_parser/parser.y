...
float_literal : NUMBER_LITERAL DOT NUMBER_LITERAL {
...
l_e_comparison : sum L_COMP EQ sum {    //DONE
    $$ = newNode(nt.L_E_COMPARISON)
    $$.Children = []*ParseTree{$1, $4}
};
...
g_e_comparison : sum G_COMP EQ sum {    //DONE
    $$ = newNode(nt.G_E_COMPARISON)
    $$.Children = []*ParseTree{$1, $4}
};

e_comparison : sum EQ EQ sum {  //DONE
    $$ = newNode(nt.E_COMPARISON)
    $$.Children = []*ParseTree{$1, $4}
};

n_e_comparison : sum NOT EQ sum {   //DONE
